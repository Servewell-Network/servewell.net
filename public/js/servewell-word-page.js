...
(() => {
  ...
  var BOOK_ORDER = {};
  var BOOK_ORDER_ARRAY = Object.keys(BOOK_TO_DISPLAY_NAME);
  ...
  function docInstHtml(inst, rendering) {
  ...
  function renderByDocument(slots, bookPreviews, overflow) {
    if (bookPreviews && Object.keys(bookPreviews).length > 0) {
      const overflowByBook = /* @__PURE__ */ new Map();
      if (overflow) {
